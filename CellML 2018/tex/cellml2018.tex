...
\end{figure}
	\begin{itemize}
		...
		\item Arrows indicate positive $f$ (sign convention).
\end{itemize}
\end{frame}
\begin{frame}
...
\begin{itemize}
	...
	\item \only<1,3-4>{Prof. Peter Gawthrop} \only<2>{\emph{Prof. Peter Gawthrop}}
	\item Michael Pan
	\item PC
\end{itemize}
\only<1>{
	\url{https://systemsbiologylaboratory.org/}\\
	\vspace{10pt}
